...
<?php
	...
	$consulta = $pdo->query("SELECT * FROM tbl_livro WHERE cd_livro='$cd'");	
	$exibe = $consulta->fetch(PDO::FETCH_ASSOC);
	
	$consultaCat = $pdo->query("SELECT cd_categoria, ds_categoria FROM tbl_categoria where cd_categoria='$cd2' union select cd_categoria, ds_categoria FROM tbl_categoria where cd_categoria !='$cd2'");
	
	$consultaAutor = $pdo->query("SELECT cd_autor, nm_autor FROM tbl_autor where cd_autor='$cd3' union select cd_autor, nm_autor FROM tbl_autor where cd_autor !='$cd3'");
