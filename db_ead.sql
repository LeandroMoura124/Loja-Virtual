...
'<p>A nova certificação MCSA (Microsoft Certified Solutions Associate) é um título atribuído a profissionais da área de TI que
 ...
 -- No select abaixo, devemos criar uma view para simplificar os codigos
...
insert into tbl_usuario
			values(Default, 'Orlindo Omiya', 'orlindo@gmail.com', 'orlindo123', 1, 'Rua Adamastor, 58', 'Santos', '05252-820'),
...
update tbl_livro
set ds_capa = 'mcsa.jpg'
where cd_livro = 14;


create User 'leo'@'localhost' IDENTIFIED WITH mysql_native_password BY '123456';
grant all privileges on db_ead.* TO 'leo'@'localhost' with grant option;
