...
include 'Conexao2.php';  // incluindo a conexao
...
$consulta = $pdo->query("SELECT ds_capa FROM tbl_livro WHERE cd_livro='$cd_livro'"); 
...
try {
	...
	$alterar = $pdo->query("UPDATE tbl_livro SET  
