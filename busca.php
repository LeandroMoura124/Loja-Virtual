...
<body>
    ...
    $consulta = $pdo->query("select * from vw_livro where nm_livro like concat ('%', '$pesquisa', '%') or nm_autor like concat ('%', '$pesquisa', '%')");
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 15px;">
            <div class="col-sm-1 col-sm-offset-1"><img src="imagens/<?php echo $exibe['ds_capa'] ?>.jpg" class="img-responsive" style="width:80%"></div>
